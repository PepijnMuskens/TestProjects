    ...
    public class NeuralNetwork
    {
        ...
        public void Learn(DataPointnetwork[] trainingData, double learnRate, double regularization = 0, double momentum = 0)
        {
        ...
        void UpdateGradients(DataPointnetwork data, NetworkLearnData learnData)
        {
